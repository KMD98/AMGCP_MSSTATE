...
#define vry PA7
#define max_speed 40
#define differential_speed 30 //Always less than max speed and ensure max_speed - differential is not smaller than 0rpm.
...
void convertInttoChar(){
  //Convert the two rpm values at index 0 and 2 into separate values per index in the data_sent array. The result is typcast to a char by adding character 0
