...
int PWM[] = {PB3,PB0,PB1,PB4}; //motor 1,motor2,motor3,motor4. MAKE SURE MOTORS ON ONE DRIVER ARE ON ON OPPOSITE SIDES.
...
void loop() {
  ...
  int pot_val = analogRead(PA7);
  target = map(pot_val,0,1025,0,37);
