    ...
    def spin(self):
        while not rospy.is_shutdown():
            if self.new_message:
                ...
                self.pathTracker(88.13,-95.234,self.latWP[self.counter],self.lonWP[self.counter], 88.5393,-95.192139) #processing with pathtracker.
                if self.enabled:
                    if abs(self.heading_error) < 1:
