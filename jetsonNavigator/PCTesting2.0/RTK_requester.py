...
def odometryPub():
    ...
    while not rospy.is_shutdown():
        ...
        drone_data.drone_lat = -82.1292492 #y axis
        drone_data.drone_lon = 33.1201391 #x-axis
        drone_data.drone_hmsl = 28.392
        amgcp_data.amgcp_lat = -39.1012039
        amgcp_data.amgcp_lon = 182.3102020
        amgcp_data.amgcp_height = 40.1292911
