...
void parsen() {
  ...
  temp_lat = (long)ackPacket[24 + 6] + ((long)ackPacket[25 + 6]<<8) + ((long)ackPacket[26 + 6]<<16) + ((long)ackPacket[27 + 6]<<24);
  //Get longitude with msbyte in last element. Value is multipled 10e-7. Decimal need to be moved 7 to the left
  temp_lon = (long)ackPacket[28 + 6] + ((long)ackPacket[29 + 6]<<8) + ((long)ackPacket[30 + 6]<<16) + ((long)ackPacket[31 + 6]<<24);
