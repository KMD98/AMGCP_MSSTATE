...
class NodeSubscriber:   
    ...
    def amgcp_callback(self, amgcp_data):
        ...
        if not self.processing:
            ...
            self.odometry_AMGCPdata.append(amgcp_data.amgcp_lat)
            self.odometry_AMGCPdata.append(amgcp_data.amgcp_lon)
    ...
    def drone_callback(self,drone_data):
        if not self.processing:
            ...
            self.odometry_dronedata.append(drone_data.drone_lat)
            self.odometry_dronedata.append(drone_data.drone_lon)
