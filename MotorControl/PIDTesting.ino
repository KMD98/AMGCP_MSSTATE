...
#define ENCB1 5 //motor 1 drive side rear
#define ENCB2 4 // motor 2 passenger side front
const int NMOTORS = 2;
int pwmPins[] = {2,1};
//PID Globals
