...
def poseplot():
    ...
    absolute_path = np.array([[0,0],[7.5,-3],[12.67,0],[24.0,-.92],[43,-2],[42.3,-6.8],[13,-4.5],[7.5,-3],[-0.4,-3],[0,0]])
    ...
    loop_error = math.sqrt(pow(absolute_path[0][0] - stereo_pose[1595,0],2) + math.pow(absolute_path[0][1]-stereo_pose[1595,1],2))
