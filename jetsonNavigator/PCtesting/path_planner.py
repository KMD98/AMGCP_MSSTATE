...
class NodeSubscriber:   
    def __init__(self):
        ...
        self.heading_error = 0 #in degrees
    ...
    def pathTracker(self, lat1, lon1, lat2, lon2):
        ...
        self.displacement = self.R * c  * 100000.0# Distance between MGCP and waypoint in cm
        self.waypoint_angle = degrees(atan2((sin(dLon)*cos(rLat2)),(cos(rLat1)*sin(rLat2)-sin(rLat1)*cos(rLat2)*cos(dLon))))
        self.heading_error = self.waypoint_angle - self.odometry_data[4]
    ...
    def spin(self):
        while not rospy.is_shutdown():
            if self.new_message:
                ...
                self.pathTracker(88.13,-95.234,89.154,-95.1230)
