...
class MotorDriver:
	...
	def spin(self):
		while not rospy.is_shutdown():
			...
			actual_rpm.enc1 = temp[0]
			actual_rpm.dir1= temp[1]
			actual_rpm.enc2 = temp[2]
			actual_rpm.dir2= temp[3]
			actual_rpm.enc3 = temp[4]
			actual_rpm.dir3= temp[5]
			actual_rpm.enc4 = temp[6]
			actual_rpm.dir4= temp[7]
			self.pub(actual_rpm)
			self.rate.sleep()
